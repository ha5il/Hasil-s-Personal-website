...
<html lang="en-NP">
   <head>
      ...
      <style rel="stylesheet" type="text/css" media="screen,projection">
         ...
         footer{font-family:'Kaushan Script',serif;background:#000; position:fixed; left:0px; bottom:0px; height:50px; width:100%;z-index: 99998}
      </style>
      <title>Hasil's Notes</title>
   </head>
   <body>
      ...
      <div class="container">
         <iframe src="https://sites.google.com/site/notehoster213123234234" frameborder="0" style="overflow: hidden;" height="700px" width="100%"></iframe>
      </div>
      <footer>
         <a  class="white-text"style="text-align:center">
