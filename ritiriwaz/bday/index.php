...
<meta name="keywords" content="Hasil, Paudyal, Google Games Hack, Personal Site, Hášíl, Páudýál, add in games">
...
<title>Hasil Wishes you Happy Birthday</title>
...
<p class="flow-text center">Congratulations to your mom and dad for birth of a sweet child!</p><p class="flow-text center">
Sorry that I couldn't wish them when you were born.</p>
<?php
$user=strtoupper($_GET["awesome"]);
date_default_timezone_set('Asia/Kolkata');
$date = date('d-m');
if ($user == "SPOORTHI" && $date == "12-02")
{
echo ('<ul class="collapsible" data-collapsible="accordion">
<li>
<div class="collapsible-header waves-effect waves-green flow-text orange-text" align="center"><b>HAPPY BIRTHDAY ');

echo $user;

echo(' | Click here and scroll down to reveal you gift...></b></div>
<div class="collapsible-body">
<br>
<center><img class="materialboxed" height="250px" src="./spoo.jpg"/></center>
</div>
</li>
</ul>');

}
if ($user == "SANDHYA" && $date == "26-02") //12-07
{
echo ('<ul class="collapsible" data-collapsible="accordion">
<li>
<div class="collapsible-header waves-effect waves-green flow-text orange-text" align="center"><b>HAPPY BIRTHDAY ');
...
<div class="collapsible-body">
<br>
<center><img class="materialboxed" height="250px" src="./sandy.jpg"/></center>
</div>
</li>
</ul>');
