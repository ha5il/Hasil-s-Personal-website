...
<?php include($_SERVER['DOCUMENT_ROOT'].'/allassets/colour.php');include($_SERVER['DOCUMENT_ROOT'].'/allassets/img_link.php');$pageIdentifier = "Namaste";?>
   ...
   <body>
      <div class="myloader">
         <div class="teal-text" style="position:relative; top:95%; text-align:center">
         ...
         <div class="container">
            <div>
               <section class="c-section--angle c-section--parallax-bg js-parallax-bg">
                  <img src="<?php echo "$rand_link[1]" ?>" srcset="<?php echo "$rand_link[1]" ?> 1x, <?php echo "$rand_link[1]" ?> 2x" class="c-image--responsive" >
               </section>
               ...
               <section id="parimg2" class="c-section--angle c-section--parallax-bg js-parallax-bg">
                  <img src="<?php echo "$rand_link[2]" ?>" srcset="<?php echo "$rand_link[2]" ?> 1x, <?php echo "$rand_link[2]" ?> 2x" class="c-image--responsive">
               </section>
               <div class="section white">
                  <div class="row container">
               ...
               <section id="parimg3" class="c-section--angle c-section--parallax-bg js-parallax-bg">
                  <img src="<?php echo "$rand_link[3]" ?>" srcset="<?php echo "$rand_link[3]" ?> 1x, <?php echo "$rand_link[3]" ?> 2x" class="c-image--responsive">
               </section>
               <div class="section white">
                  <div class="row container">
               ...
               <section id="parimg4" class="c-section--angle c-section--parallax-bg js-parallax-bg">
                  <img src="<?php echo "$rand_link[4]" ?>" srcset="<?php echo "$rand_link[4]" ?> 1x, <?php echo "$rand_link[4]" ?> 2x" class="c-image--responsive">
               </section>
               <div class="section white">
                  <div class="row container">
               ...
               <section id="parimg5" class="c-section--angle c-section--parallax-bg js-parallax-bg">
                  <img src="<?php echo "$rand_link[5]" ?>" srcset="<?php echo "$rand_link[5]" ?> 1x, <?php echo "$rand_link[5]" ?> 2x" class="c-image--responsive">
               </section>
            </div>
         </div>
      </fonto>
...
<?php include($_SERVER['DOCUMENT_ROOT'].'/allassets/footer.php');?>
      ...
      <script type="application/ld+json">
         ...
         "@type":"Person",
         "name":"Hasil Paudyal",
         "image":"http://hasilpaudyal.com.np/Schema-Hasil.jpg",
         ...
         "sameAs":[  
               ...
               "https://www.linkedin.com/in/hášíl-páudýál-b1770680",
