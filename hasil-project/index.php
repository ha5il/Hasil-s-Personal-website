...
<html lang="en-NP">
   <head>
      ...
      <style rel="stylesheet" media="screen,projection" type="text/css">
         ...
         footer{font-family:'Kaushan Script',serif;background:#124369; position:fixed; left:0px; bottom:0px; height:50px; width:100%;z-index: 99998}
      </style>
   ...
   <body>
      ...
      <div class="navbar-fixed">
         <ul id="dropdown1" class="dropdown-content">
            ...
            <li><a class="waves-effect waves-red tooltipped" data-position="left" data-delay="50" data-tooltip="View my projects" href="#" onclick="Materialize.toast('Authorize Yourself !', 4000, 'rounded')"><b>My Projects</b></a></li>
            <li class="divider"></li>
         ...
         <nav>
            ...
            <ul id="slide-out" class="side-nav">
               ...
               <li><a class="waves-effect waves-red" href="#" onclick="Materialize.toast('Authorize Yourself !', 4000, 'rounded')"><b>My Projects</b></a></li>
