            ...
            <div class="card-panel">
               ...
               <div class="card-panel hoverable">
                  <table class="bordered centered highlight">
                     <thead>
                        <tr>
                           <th data-field="icon" class="orange-text">
                              <h4>Logo</h4>
                           </th>
                           <th data-field="name" class="teal-text">
                              <h4>Site</h4>
                           </th>
                           <th data-field="link" class="purple-text">
                              <h4>Direct link</h4>
                           </th>
                        </tr>
                     </thead>
               ...
               <div class="divider"></div>
               <h4 class="green-text" style="text-align: center"> Codes </h4>
               <div class="divider"></div>
               <div class="card-panel hoverable">
                  <table class="bordered centered highlight">
                     <thead>
               ...
               <div class="divider"></div>
               <div class="divider"></div>
               <h4 class="green-text" style="text-align: center"> Blogs and Creative Writing </h4>
               <div class="divider"></div>
               <div class="card-panel hoverable">
                  <table class="bordered centered highlight">
                     <thead>
               ...
               <div class="divider"></div>
               <div class="divider"></div>
               <h4 class="green-text" style="text-align: center"> Entertainment </h4>
               <div class="divider"></div>
               <div class="card-panel hoverable">
                  <table class="bordered centered highlight">
                     <thead>
               ...
               <div class="divider"></div>
               <div class="divider"></div>
               <h4 class="green-text" style="text-align: center"> Professional Identity </h4>
               <div class="divider"></div>
               <div class="card-panel hoverable">
                  <table class="bordered centered highlight">
                     <thead>
               ...
               <div class="divider"></div>
               <div class="divider"></div>
               <h4 class="green-text" style="text-align: center"> Photos and Gifs </h4>
               <div class="divider"></div>
               <div class="card-panel hoverable">
                  <table class="bordered centered highlight">
                     <thead>
               ...
               <ul class="collapsible" data-collapsible="accordion">
                  <li>
                     <div class="collapsible-header waves-effect waves-green tooltipped" data-position="top" data-delay="50" data-tooltip="This option will send me an email | Click and scroll down" align="center">
                        <h4>Quick Contact</h4>
                     </div>
